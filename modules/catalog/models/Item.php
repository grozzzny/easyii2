...
class Item extends \yii\easyii2\components\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'description' => Yii::t('easyii2', 'Description'),
            'available' => Yii::t('easyii2/catalog', 'Available'),
            'price' => Yii::t('easyii2/catalog', 'Price'),
            'discount' => Yii::t('easyii2/catalog', 'Discount'),
