...
/**
 * Gallery module API
 * @package yii\easyii2\modules\gallery\api
 *
 ...
 * @method static PhotoObject[] last(int $limit = 1, mixed $where = null) Get last photos, use $where option for fetching photos from special category
 * @method static string pages() returns pagination html generated by yii\widgets\LinkPager widget.
 * @method static \stdClass pagination() returns yii\data\Pagination object.
 *
 * @method static void plugin(array $options = [])
 */

class Gallery extends \yii\easyii2\components\API
{
    private $_cats;
    private $_photos;
    private $_last;
