...
return [
    ...
    'easyii2CMS is already installed. If you want to reinstall easyii2CMS, please drop all tables with prefix `easyii2_` from your database manually.' => 'easyii2CMS уже установлена. Если вы хотите произвести переустановку, удалите все таблицы с префиксом `easyii2_` в вашей базе данных.'
];