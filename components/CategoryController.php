...
class CategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('@easyii2/views/category/index', [
            'cats' => $class::cats()
        ]);
    }
    ...
    public function actionCreate($parent = null)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if(!$model->hasErrors()){
                    $this->flash('success', Yii::t('easyii2', 'Category created'));
            ...
            return $this->render('@easyii2/views/category/create', [
                'model' => $model,
                'parent' => $parent
            ]);
        }
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('easyii2', 'Category updated'));
                }
                else{
            ...
            return $this->render('@easyii2/views/category/edit', [
                'model' => $model
            ]);
        }
    }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii2', 'Category deleted'));
    }
